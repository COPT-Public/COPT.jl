...
function COPT_GetCpuAffinity(env, cpuList, len, pReqSize)
    ccall((:COPT_GetCpuAffinity, libcopt), Cint, (Ptr{copt_env}, Ptr{Cint}, Cint, Ptr{Cint}), env, cpuList, len, pReqSize)
end

function COPT_SetCpuAffinity(env, hexMask)
    ccall((:COPT_SetCpuAffinity, libcopt), Cint, (Ptr{copt_env}, Ptr{Cchar}), env, hexMask)
end

function COPT_BindNumaCpu(env, numaNode)
    ccall((:COPT_BindNumaCpu, libcopt), Cint, (Ptr{copt_env}, Cint), env, numaNode)
end

function COPT_BindNumaMem(env, numaNode)
    ccall((:COPT_BindNumaMem, libcopt), Cint, (Ptr{copt_env}, Cint), env, numaNode)
end

function COPT_GetNumaNodeCount(env, pCnt)
    ccall((:COPT_GetNumaNodeCount, libcopt), Cint, (Ptr{copt_env}, Ptr{Cint}), env, pCnt)
end
...
function COPT_ClearProb(prob)
    ccall((:COPT_ClearProb, libcopt), Cint, (Ptr{copt_prob},), prob)
end
...
function COPT_AddExpCones(prob, nAddCone, coneType, coneIdx)
    ccall((:COPT_AddExpCones, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}), prob, nAddCone, coneType, coneIdx)
end

function COPT_AddAffineCone(prob, coneType, nConeDim, nAlphaDim, alphaElem, psdBeg, psdCnt, psdColIdx, psdMatIdx, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowConst, name)
    ccall((:COPT_AddAffineCone, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cchar}), prob, coneType, nConeDim, nAlphaDim, alphaElem, psdBeg, psdCnt, psdColIdx, psdMatIdx, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowConst, name)
end
...
function COPT_AddNLConstr(prob, nToken, nTokenElem, token, tokenElem, nRowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, dRowUpper, name)
    ccall((:COPT_AddNLConstr, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Ptr{Cdouble}, Cchar, Cdouble, Cdouble, Ptr{Cchar}), prob, nToken, nTokenElem, token, tokenElem, nRowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, dRowUpper, name)
end

function COPT_AddNLConstrs(prob, nConstrs, tokenBeg, tokenCnt, tokenElemBeg, tokenElemCnt, token, tokenElem, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowSense, rowBound, rowUpper, rowNames)
    ccall((:COPT_AddNLConstrs, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cchar}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Ptr{Cchar}}), prob, nConstrs, tokenBeg, tokenCnt, tokenElemBeg, tokenElemCnt, token, tokenElem, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowSense, rowBound, rowUpper, rowNames)
end
...
function COPT_AddIndicators(prob, nInd, indType, binColIdx, binColVal, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, indNames)
    ccall((:COPT_AddIndicators, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cchar}, Ptr{Cdouble}, Ptr{Ptr{Cchar}}), prob, nInd, indType, binColIdx, binColVal, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, indNames)
end
...
function COPT_GetExpCones(prob, nCone, list, coneType, coneIdx, nElemSize, pReqSize)
    ccall((:COPT_GetExpCones, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}), prob, nCone, list, coneType, coneIdx, nElemSize, pReqSize)
end

function COPT_GetAffineCone(prob, affConeIdx, coneType, nConeDim, nAlphaDim, alphaElem, psdBeg, psdCnt, psdColIdx, psdMatIdx, nPsdElemSize, pPsdReqSize, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowConst, nElemSize, pReqSize)
    ccall((:COPT_GetAffineCone, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Cint, Ptr{Cint}), prob, affConeIdx, coneType, nConeDim, nAlphaDim, alphaElem, psdBeg, psdCnt, psdColIdx, psdMatIdx, nPsdElemSize, pPsdReqSize, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, rowConst, nElemSize, pReqSize)
end
...
function COPT_GetNLConstr(prob, nlConstrIdx, token, tokenElem, nToken, nTokenElem, pReqToken, pReqTokenElem, rowMatIdx, rowMatElem, dRowLower, dRowUpper, nElemSize, pReqElemSize)
    ccall((:COPT_GetNLConstr, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cdouble}, Cint, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Cint, Ptr{Cint}), prob, nlConstrIdx, token, tokenElem, nToken, nTokenElem, pReqToken, pReqTokenElem, rowMatIdx, rowMatElem, dRowLower, dRowUpper, nElemSize, pReqElemSize)
end
...
function COPT_GetIndicators(prob, nInd, list, indType, binColIdx, binColVal, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, nElemSize, pReqSize)
    ccall((:COPT_GetIndicators, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cchar}, Ptr{Cdouble}, Cint, Ptr{Cint}), prob, nInd, list, indType, binColIdx, binColVal, rowMatBeg, rowMatCnt, rowMatIdx, rowMatElem, cRowSense, dRowBound, nElemSize, pReqSize)
end
...
function COPT_SetElems(prob, nelem, cols, rows, elems)
    ccall((:COPT_SetElems, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), prob, nelem, cols, rows, elems)
end
...
function COPT_DelExpCones(prob, num, list)
    ccall((:COPT_DelExpCones, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}), prob, num, list)
end

function COPT_DelAffineCones(prob, num, list)
    ccall((:COPT_DelAffineCones, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}), prob, num, list)
end
...
function COPT_DelNLConstrs(prob, num, list)
    ccall((:COPT_DelNLConstrs, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}), prob, num, list)
end
...
function COPT_SetNLObj(prob, nToken, nTokenElem, token, tokenElem)
    ccall((:COPT_SetNLObj, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, nToken, nTokenElem, token, tokenElem)
end

function COPT_GetNLObj(prob, p_nToken, p_nTokenElem, token, tokenElem)
    ccall((:COPT_GetNLObj, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), prob, p_nToken, p_nTokenElem, token, tokenElem)
end

function COPT_DelNLObj(prob)
    ccall((:COPT_DelNLObj, libcopt), Cint, (Ptr{copt_prob},), prob)
end
...
function COPT_SetColBranchFactors(prob, num, list, branchFactors)
    ccall((:COPT_SetColBranchFactors, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, num, list, branchFactors)
end
...
function COPT_SetAffineConeNames(prob, num, list, names)
    ccall((:COPT_SetAffineConeNames, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Ptr{Cchar}}), prob, num, list, names)
end
...
function COPT_SetNLConstrLower(prob, num, list, lower)
    ccall((:COPT_SetNLConstrLower, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, num, list, lower)
end

function COPT_SetNLConstrUpper(prob, num, list, upper)
    ccall((:COPT_SetNLConstrUpper, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, num, list, upper)
end

function COPT_SetNLConstrNames(prob, num, list, names)
    ccall((:COPT_SetNLConstrNames, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Ptr{Cchar}}), prob, num, list, names)
end
...
function COPT_SetIndicatorNames(prob, num, list, names)
    ccall((:COPT_SetIndicatorNames, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Ptr{Cchar}}), prob, num, list, names)
end
...
function COPT_MultiObjSetColObj(prob, iObj, num, list, colObj)
    ccall((:COPT_MultiObjSetColObj, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, iObj, num, list, colObj)
end

function COPT_MultiObjGetColObj(prob, iObj, num, list, colObj)
    ccall((:COPT_MultiObjGetColObj, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, iObj, num, list, colObj)
end

function COPT_MultiObjDelColObj(prob, iObj)
    ccall((:COPT_MultiObjDelColObj, libcopt), Cint, (Ptr{copt_prob}, Cint), prob, iObj)
end

function COPT_MultiObjSetObjSense(prob, iObj, iObjSense)
    ccall((:COPT_MultiObjSetObjSense, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint), prob, iObj, iObjSense)
end

function COPT_MultiObjSetObjConst(prob, iObj, dObjConst)
    ccall((:COPT_MultiObjSetObjConst, libcopt), Cint, (Ptr{copt_prob}, Cint, Cdouble), prob, iObj, dObjConst)
end

function COPT_MultiObjSetObjParam(prob, iObj, paramName, dblParam)
    ccall((:COPT_MultiObjSetObjParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cdouble), prob, iObj, paramName, dblParam)
end

function COPT_MultiObjGetObjParam(prob, iObj, paramName, p_dblParam)
    ccall((:COPT_MultiObjGetObjParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Ptr{Cdouble}), prob, iObj, paramName, p_dblParam)
end

function COPT_MultiObjResetObjParam(prob, iObj)
    ccall((:COPT_MultiObjResetObjParam, libcopt), Cint, (Ptr{copt_prob}, Cint), prob, iObj)
end

function COPT_MultiObjSetIntParam(prob, iObj, paramName, intParam)
    ccall((:COPT_MultiObjSetIntParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cint), prob, iObj, paramName, intParam)
end

function COPT_MultiObjGetIntParam(prob, iObj, paramName, p_intParam)
    ccall((:COPT_MultiObjGetIntParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Ptr{Cint}), prob, iObj, paramName, p_intParam)
end

function COPT_MultiObjSetDblParam(prob, iObj, paramName, dblParam)
    ccall((:COPT_MultiObjSetDblParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cdouble), prob, iObj, paramName, dblParam)
end

function COPT_MultiObjGetDblParam(prob, iObj, paramName, p_dblParam)
    ccall((:COPT_MultiObjGetDblParam, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Ptr{Cdouble}), prob, iObj, paramName, p_dblParam)
end

function COPT_MultiObjResetParam(prob, iObj)
    ccall((:COPT_MultiObjResetParam, libcopt), Cint, (Ptr{copt_prob}, Cint), prob, iObj)
end

function COPT_MultiObjGetIntAttr(prob, iObj, attrName, p_intAttr)
    ccall((:COPT_MultiObjGetIntAttr, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Ptr{Cint}), prob, iObj, attrName, p_intAttr)
end

function COPT_MultiObjGetDblAttr(prob, iObj, attrName, p_dblAttr)
    ccall((:COPT_MultiObjGetDblAttr, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Ptr{Cdouble}), prob, iObj, attrName, p_dblAttr)
end

function COPT_MultiObjGetPoolObjVal(prob, iObj, iSol, p_objVal)
    ccall((:COPT_MultiObjGetPoolObjVal, libcopt), Cint, (Ptr{copt_prob}, Cint, Cint, Ptr{Cdouble}), prob, iObj, iSol, p_objVal)
end
...
function COPT_ReadJsonSol(prob, solfilename)
    ccall((:COPT_ReadJsonSol, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}), prob, solfilename)
end
...
function COPT_ReadOrd(prob, ordfilename)
    ccall((:COPT_ReadOrd, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}), prob, ordfilename)
end
...
function COPT_WriteNL(prob, nlfilename)
    ccall((:COPT_WriteNL, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}), prob, nlfilename)
end
...
function COPT_WriteJsonSol(prob, solfilename)
    ccall((:COPT_WriteJsonSol, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}), prob, solfilename)
end
...
function COPT_WriteOrd(prob, ordfilename)
    ccall((:COPT_WriteOrd, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}), prob, ordfilename)
end
...
function COPT_SetNLPrimalStart(prob, num, list, colVal)
    ccall((:COPT_SetNLPrimalStart, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, num, list, colVal)
end
...
function COPT_GetAffineConeIdx(prob, affConeName, p_iAffCone)
    ccall((:COPT_GetAffineConeIdx, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}, Ptr{Cint}), prob, affConeName, p_iAffCone)
end
...
function COPT_GetNLConstrIdx(prob, nlConstrName, p_iNLConstr)
    ccall((:COPT_GetNLConstrIdx, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}, Ptr{Cint}), prob, nlConstrName, p_iNLConstr)
end
...
function COPT_GetIndicatorIdx(prob, indicatorName, p_iIndicator)
    ccall((:COPT_GetIndicatorIdx, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}, Ptr{Cint}), prob, indicatorName, p_iIndicator)
end
...
function COPT_GetNLConstrInfo(prob, infoName, num, list, info)
    ccall((:COPT_GetNLConstrInfo, libcopt), Cint, (Ptr{copt_prob}, Ptr{Cchar}, Cint, Ptr{Cint}, Ptr{Cdouble}), prob, infoName, num, list, info)
end
...
function COPT_GetAffineConeName(prob, iAffCone, buff, buffSize, pReqSize)
    ccall((:COPT_GetAffineConeName, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cint, Ptr{Cint}), prob, iAffCone, buff, buffSize, pReqSize)
end
...
function COPT_GetNLConstrName(prob, iNLConstr, buff, buffSize, pReqSize)
    ccall((:COPT_GetNLConstrName, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cint, Ptr{Cint}), prob, iNLConstr, buff, buffSize, pReqSize)
end
...
function COPT_GetIndicatorName(prob, iIndicator, buff, buffSize, pReqSize)
    ccall((:COPT_GetIndicatorName, libcopt), Cint, (Ptr{copt_prob}, Cint, Ptr{Cchar}, Cint, Ptr{Cint}), prob, iIndicator, buff, buffSize, pReqSize)
end
...
const COPT_INDICATOR_IF = 1

const COPT_INDICATOR_ONLYIF = 2

const COPT_INDICATOR_IFANDONLYIF = 3

const COPT_CONE_QUAD = 1

const COPT_CONE_RQUAD = 2

const COPT_EXPCONE_PRIMAL = 3

const COPT_EXPCONE_DUAL = 4
...
const COPT_RETCODE_MEMORY_GPU = 9
...
const COPT_LPSTATUS_ITERLIMIT = 11
...
const COPT_DBLPARAM_NLPTOL = "NLPTol"
...
const COPT_DBLPARAM_MULTIOBJTIMELIMIT = "MultiObjTimeLimit"

const COPT_INTPARAM_LOGGING = "Logging"

const COPT_INTPARAM_LOGLEVEL = "LogLevel"
...
const COPT_INTPARAM_CONCURRENTLPMODE = "ConcurrentLpMode"
...
const COPT_INTPARAM_REQSENSITIVITY = "ReqSensitivity"
...
const COPT_INTPARAM_PREROOTHEURLEVEL = "PreRootHeurLevel"
...
const COPT_INTPARAM_NONCONVEX = "NonConvex"

const COPT_INTPARAM_NLPMUUPDATE = "NLPMuUpdate"

const COPT_INTPARAM_NLPLINSCALE = "NLPLinScale"

const COPT_INTPARAM_NLPITERLIMIT = "NLPIterLimit"
...
const COPT_INTPARAM_MULTIOBJPARAMMODE = "MultiObjParamMode"

const COPT_INTPARAM_LAZYCONSTRAINTS = "LazyConstraints"

const COPT_INTPARAM_LINEARIZEINDICATORS = "LinearizeIndicators"

const COPT_INTPARAM_LINEARIZESOS = "LinearizeSos"

const COPT_INTPARAM_MIPREPAIR = "MipRepair"

const COPT_INTPARAM_MIPNLPITERLIMIT = "MipNLPIterLimit"
...
const COPT_INTATTR_MULTIOBJS = "MultiObjs"
...
const COPT_INTATTR_NLELEMS = "NLElems"
...
const COPT_INTATTR_EXPCONES = "ExpCones"

const COPT_INTATTR_AFFINECONES = "AffineCones"

const COPT_INTATTR_QCONSTRS = "QConstrs"

const COPT_INTATTR_NLCONSTRS = "NLConstrs"
...
const COPT_INTATTR_PDLPITER = "PDLPIter"
...
const COPT_INTATTR_HASBRANCHFACTOR = "HasBranchFactor"

const COPT_INTATTR_HASQOBJ = "HasQObj"

const COPT_INTATTR_HASNLOBJ = "HasNLObj"
...
const COPT_INTATTR_HASSENSITIVITY = "HasSensitivity"
...
const COPT_DBLINFO_BRANCHFACTOR = "BranchFactor"

const COPT_DBLINFO_SAOBJLOW = "SAObjLow"

const COPT_DBLINFO_SAOBJUP = "SAObjUp"

const COPT_DBLINFO_SALBLOW = "SALBLow"

const COPT_DBLINFO_SALBUP = "SALBUp"

const COPT_DBLINFO_SAUBLOW = "SAUBLow"

const COPT_DBLINFO_SAUBUP = "SAUBUp"

const COPT_NL_PLUS = -10

const COPT_NL_MINUS = -11

const COPT_NL_MULT = -12

const COPT_NL_DIV = -13

const COPT_NL_POW = -14

const COPT_NL_SQRT = -15

const COPT_NL_EXP = -16

const COPT_NL_LOG = -17

const COPT_NL_LOG10 = -18

const COPT_NL_NEG = -19

const COPT_NL_ABS = -20

const COPT_NL_FLOOR = -21

const COPT_NL_CEIL = -22

const COPT_NL_SIN = -31

const COPT_NL_COS = -32

const COPT_NL_TAN = -33

const COPT_NL_SINH = -34

const COPT_NL_COSH = -35

const COPT_NL_TANH = -36

const COPT_NL_ASIN = -41

const COPT_NL_ACOS = -42

const COPT_NL_ATAN = -43

const COPT_NL_ASINH = -44

const COPT_NL_ACOSH = -45

const COPT_NL_ATANH = -46

const COPT_NL_ATAN2 = -47

const COPT_NL_SUM = -50

const COPT_NL_GET = -60

const COPT_NL_POSTFIX = -99

const COPT_EVALTYPE_OBJVAL = 1

const COPT_EVALTYPE_CONSTRVAL = 2

const COPT_EVALTYPE_GRADIENT = 4

const COPT_EVALTYPE_JACOBIAN = 8

const COPT_EVALTYPE_HESSIAN = 16

const COPT_DENSETYPE_ROWMAJOR = -1

const COPT_DENSETYPE_COLMAJOR = -2

const COPT_MULTIOBJ_PRIORITY = "MultiObjPriority"

const COPT_MULTIOBJ_WEIGHT = "MultiObjWeight"

const COPT_MULTIOBJ_ABSTOL = "MultiObjAbsTol"

const COPT_MULTIOBJ_RELTOL = "MultiObjRelTol"

const COPT_CLIENT_CAFILE = "CaFile"

const COPT_CLIENT_CERTFILE = "CertFile"

const COPT_CLIENT_CERTKEYFILE = "CertKeyFile"
